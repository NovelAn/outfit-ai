...
export const ScreenWardrobe: React.FC<ScreenWardrobeProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="bg-[#fbf9f4] text-[#1b1c19] min-h-screen pb-32">
      ...
      {/* Item Detail Modal */}
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-3 pt-20 pb-[calc(7rem+env(safe-area-inset-bottom))] overflow-hidden">
          <div className="bg-[#fbf9f4] p-4 max-w-sm w-full max-h-[calc(100dvh-12rem)] overflow-y-auto rounded-lg border border-[#162839] relative shadow-2xl">
            <div
